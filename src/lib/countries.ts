export const countries = [
    ...
    { name: 'Åland Islands', code: 'AX', dial: '+358', flag: '🇦🇽' },
    ...
    { name: 'Bolivia, Plurinational State of bolivia', code: 'BO', dial: '+591', flag: '🇧🇴' },
    ...
    { name: 'Brunei Darussalam', code: 'BN', dial: '+673', flag: '🇧🇳' },
    ...
    { name: 'Cayman Islands', code: 'KY', dial: '+345', flag: '🇰🇾' },
    ...
    { name: 'Congo, The Democratic Republic of the Congo', code: 'CD', dial: '+243', flag: '🇨🇩' },
    ...
    { name: 'Dominican Republic', code: 'DO', dial: '+1849', flag: '🇩🇴' },
    ...
    { name: 'Falkland Islands (Malvinas)', code: 'FK', dial: '+500', flag: '🇫🇰' },
    ...
    { name: 'French Southern Territories', code: 'TF', dial: '+262', flag: '🇹🇫' },
    ...
    { name: 'Holy See (Vatican City State)', code: 'VA', dial: '+379', flag: '🇻🇦' },
    ...
    { name: 'Iran, Islamic Republic of Persian Gulf', code: 'IR', dial: '+98', flag: '🇮🇷' },
    ...
    { name: 'Korea, Democratic People\'s Republic of Korea', code: 'KP', dial: '+850', flag: '🇰🇵' },
    { name: 'Korea, Republic of South Korea', code: 'KR', dial: '+82', flag: '🇰🇷' },
    ...
    { name: 'Libyan Arab Jamahiriya', code: 'LY', dial: '+218', flag: '🇱🇾' },
    ...
    { name: 'Micronesia, Federated States of Micronesia', code: 'FM', dial: '+691', flag: '🇫🇲' },
    ...
    { name: 'Palestinian Territory, Occupied', code: 'PS', dial: '+970', flag: '🇵🇸' },
    ...
    { name: 'Puerto Rico', code: 'PR', dial: '+1939', flag: '🇵🇷' },
    ...
    { name: 'Syrian Arab Republic', code: 'SY', dial: '+963', flag: '🇸🇾' },
    { name: 'Taiwan', code: 'TW', dial: '+886', flag: '🇹🇼' },
    { name: 'Tajikistan', code: 'TJ', dial: '+992', flag: '🇹🇯' },
    { name: 'Tanzania, United Republic of Tanzania', code: 'TZ', dial: '+255', flag: '🇹🇿' },
    ...
    { name: 'Venezuela, Bolivarian Republic of Venezuela', code: 'VE', dial: '+58', flag: '🇻🇪' },
    { name: 'Vietnam', code: 'VN', dial: '+84', flag: '🇻🇳' },
    { name: 'Virgin Islands, British', code: 'VG', dial: '+1284', flag: '🇻🇬' },
    { name: 'Virgin Islands, U.S.', code: 'VI', dial: '+1340', flag: '🇻🇮' },
